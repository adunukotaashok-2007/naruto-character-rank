...
/* =========================================================
   CHARACTER DATABASE
   IMPORTANT:
   Names and image paths are kept together so the
   server and browser cannot disagree about characters.
   ========================================================= */
...
function handleRankSelect(socket, data) {
    ...
    if (
        ...
        category !== room.rank.categoryIndex
    ) {
